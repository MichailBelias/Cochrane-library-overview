...
check =  grep("randomised clinical | randomised controlled | RCT | randomised control | placebo | randomized clinical | randomized controlled | RCT | randomized control | placebo ", lapply(Abstracts, tolower))

for ( i in check){
temp = vector()
temp = grep("randomised clinical | randomised controlled | RCT | randomised control | placebo | randomized clinical | randomized controlled | RCT | randomized control | placebo ", 
