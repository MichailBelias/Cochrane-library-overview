...
* variance and baseline risk (i.e. mean placebo group outcome) in each study, 
...
* LEARNING POINT: The metan comand uses DL (methods-of-moments) to 
* estimate tau-squared. We can do REML in the second stage of our meta-analysis 
* using either metareg or metaan or admetan.
...
* a primary analysis choice in the protocol, and the impact of other 
