...
* estimates; I  removed this to maintain compatability with my use of admetan
* (where i used standard CIs, rather than Hartung-Knapp CIs).

* But we should really account for uncertainty.
* Let us therefore do this in mvmeta:
mvmeta y v, vars(y1)
...
* i.e. we now includes two outcomes, y1 and y2
mvmeta y v
...
* run the code below altogether: from preserve to restore 
preserve
...
* To simplify matters, we could create a summary dataset and then use 'metan'.
